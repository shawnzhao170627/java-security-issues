...
[查看完整周报](docs/news/2026/2026-W16) | [历史归档](docs/news/README)
...
| 标准 | 说明 | 文档 |
|------|------|------|
| OWASP LLM Top 10 | LLM 应用安全风险 Top 10 | [中文](docs/classification/owasp-llm-top10) |
| AI 安全动态 | Java 生态 AI/LLM 安全追踪 | [查看](docs/news/ai-security) |
...
| 漏洞 | 严重程度 | 文档 |
|------|---------|------|
| SQL 注入 | Critical | [查看](docs/vulnerabilities/injection/sql-injection) |
| SSTI 模板注入 | Critical | [查看](docs/vulnerabilities/injection/ssti) |
| SpEL 注入 | Critical | [查看](docs/vulnerabilities/injection/spel-injection) |
| ScriptEngine RCE | Critical | [查看](docs/vulnerabilities/injection/script-engine-rce) |
| XStream 反序列化 | Critical | [查看](docs/vulnerabilities/deserialization/xstream-deserialization) |
| CSRF | High | [查看](docs/vulnerabilities/authentication/csrf) |
| JWT 安全漏洞 | High | [查看](docs/vulnerabilities/authentication/jwt-vulnerability) |
| Actuator 未授权访问 | High | [查看](docs/vulnerabilities/configuration/actuator) |
| QLExpress RCE | High | [查看](docs/vulnerabilities/injection/qlexpress-rce) |
| CORS 配置错误 | Medium | [查看](docs/vulnerabilities/configuration/cors-misconfiguration) |
| CRLF 注入 | Medium | [查看](docs/vulnerabilities/injection/crlf-injection) |
| IP 伪造 | Medium | [查看](docs/vulnerabilities/authentication/ip-forgery) |
| 开放重定向 | Medium | [查看](docs/vulnerabilities/injection/open-redirect) |
| JSONP 劫持 | Medium | [查看](docs/vulnerabilities/authentication/jsonp-hijacking) |
| URL 白名单绕过 | Medium | [查看](docs/vulnerabilities/authentication/url-whitelist-bypass) |
| Swagger 信息泄露 | Low | [查看](docs/vulnerabilities/configuration/swagger-info-disclosure) |

#### LLM 应用安全漏洞

| 类别 | 说明 | 文档 |
|------|------|------|
| Prompt 注入 | 恶意输入操纵 LLM 行为 | [查看](docs/vulnerabilities/llm/prompt-injection) |
| 不安全输出处理 | LLM 输出未验证导致 XSS/RCE | [查看](docs/vulnerabilities/llm/insecure-output-handling) |
| 训练数据投毒 | RAG 知识库植入后门 | [查看](docs/vulnerabilities/llm/training-data-poisoning) |
| LLM 拒绝服务 | 消耗计算资源干扰服务 | [查看](docs/vulnerabilities/llm/model-dos) |
| LLM 供应链漏洞 | 恶意模型、依赖漏洞 | [查看](docs/vulnerabilities/llm/supply-chain) |
| 敏感信息泄露 | LLM 泄露敏感数据 | [查看](docs/vulnerabilities/llm/sensitive-data-disclosure) |
| 不安全插件设计 | 插件安全缺陷 | [查看](docs/vulnerabilities/llm/insecure-plugin-design) |
| 过度自主权 | Agent 权限过大 | [查看](docs/vulnerabilities/llm/excessive-agency) |
| 硬编码 API 密钥 | LLM 密钥硬编码 | [查看](docs/vulnerabilities/llm/hardcoded-api-key) |
...
| 框架/组件 | 典型漏洞 | 文档 |
|-----------|---------|------|
| Spring | SpEL注入、RCE | [查看](docs/frameworks/spring) |
| Struts2 | OGNL注入、RCE | [查看](docs/frameworks/struts2) |
| Shiro | RememberMe反序列化 | [查看](docs/frameworks/shiro) |
| Fastjson | AutoType反序列化 | [查看](docs/frameworks/fastjson) |
| Log4j2 | JNDI注入、RCE | [查看](docs/frameworks/log4j2) |

#### LLM/AI 框架

| 框架 | 安全关注点 | 文档 |
|------|-----------|------|
| Spring AI | Prompt注入防护、API密钥管理 | [查看](docs/frameworks/spring-ai) |
| LangChain4j | Agent安全、工具调用风险 | [查看](docs/frameworks/langchain4j) |
...
- 贡献内容：请阅读 [贡献指南](contributing/how-to-contribute)
- 贡献代码示例：请阅读 [代码示例指南](contributing/code-examples)
