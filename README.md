...
| 标准 | 说明 | 文档 |
|------|------|------|
| OWASP Top 10:2025 | Web 应用安全风险 Top 10 | [中文](docs/classification/owasp-top10.md) / [English](docs/classification/owasp-top10-en.md) |
| CWE Top 25:2025 | 最危险软件弱点 Top 25 | [中文](docs/classification/cwe-top25.md) / [English](docs/classification/cwe-top25-en.md) |
| Java 专项分类 | Java 特有安全问题 | [中文](docs/classification/java-specific.md) / [English](docs/classification/java-specific-en.md) |
